# Operator Quickstart — Manufacture of paints, varnishes and similar coatings, printing ink and mastics

Shortest path from clone to a verified local dry-run for **ISIC 2022** (`cloud-itonami-isic-2022`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2022.git
cd cloud-itonami-isic-2022
```
...
- Blueprint governor key: `paint-coatings-plant-operations-governor`
- Likely source path: `paintmfg.governor.cljc`
