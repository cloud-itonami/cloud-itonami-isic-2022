# Business Model: Manufacture of paints, varnishes and similar coatings, printing ink and mastics
...
## Classification
- Repository: `cloud-itonami-isic-2022` ([github.com/cloud-itonami/cloud-itonami-isic-2022](https://github.com/cloud-itonami/cloud-itonami-isic-2022))
- ISIC Rev.5: `2022` — Manufacture of paints, varnishes and similar coatings, printing ink and mastics
- Domain: `:paint-coatings-ink-mastics/manufacturing`
- Social impact: :worker-safety :consumer-safety :environmental-safety
- Actor: `:paint-coatings-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :paint-coatings-ink-mastics/manufacturing — who wants
...
One managed tenant (:paint-coatings-ink-mastics/manufacturing):
...
- Do not bypass the `:paint-coatings-plant-operations-governor` for production decisions.
