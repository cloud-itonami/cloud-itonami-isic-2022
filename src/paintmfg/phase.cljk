(ns paintmfg.phase
  "Phase 0->3 staged rollout for the paints, varnishes and similar
  ...
  consequence (a mixing/dispersion or tinting/filling-line maintenance
  window means production downtime, and the equipment ends up actually
  touched); it is always a human plant supervisor's call.
  `paintmfg.governor`'s `line-actuate-blocked-violations` HARD-blocks
...
(defn verdict->disposition
  "Map a Paint & Coatings Plant Operations Governor verdict to a base
